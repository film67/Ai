...
const translations = {
  ru: {
    nav: { test:"AI-тест", philosophy:"Философия", programs:"Курсы", pricing:"Цены", process:"Процесс обучения", faq:"Вопросы", contact:"Контакты", contactBtn:"Контакт", cta:"Оставить заявку", themeToDark:"Включить тёмную тему", themeToLight:"Включить светлую тему" , consulting:"Для бизнеса"},
    hero: {
    ...
    quiz: {
      ...
      results:{
        "vibecoding-beginner":{tag:"Вайб-кодинг · CODE", title:"Вайб-кодинг, уровень CODE", desc:"Replit, Lovable и первое приложение без единой строчки кода — всё в браузере, устанавливать ничего не нужно. Первое занятие бесплатное: можно прийти и проверить."},
        "vibecoding-intermediate":{tag:"Вайб-кодинг · BUILD", title:"Вайб-кодинг, уровень BUILD", desc:"Cursor и Claude Code на вашем компьютере, база данных со связями, оплата Click и Payme с проверкой на сервере — для тех, у кого первый прототип уже собран."},
        "vibecoding-advanced":{tag:"Вайб-кодинг · LAUNCH", title:"Вайб-кодинг, уровень LAUNCH", desc:"CI/CD, аудит собственного продукта глазами атакующего и запуск SaaS — для тех, кто готов довести продукт до реальных пользователей и защитить его."},
        "automation-beginner":{tag:"Автоматизация · CONNECT", title:"ИИ для автоматизации, уровень CONNECT", desc:"Make.com и Telegram-бот, который отвечает клиентам сам. Без кода — если умеете пользоваться таблицами, справитесь."},
        "automation-intermediate":{tag:"Автоматизация · AUTOMATE", title:"ИИ для автоматизации, уровень AUTOMATE", desc:"Вебхуки, AI-агенты и оплата через Click или Payme — для тех, у кого первые сценарии уже работают."},
        "automation-advanced":{tag:"Автоматизация · SCALE", title:"ИИ для автоматизации, уровень SCALE", desc:"Flowise, n8n и омниканальная система с автоотчётами — для тех, кому нужна система уровня агентства без агентства."},
        "marketing-beginner":{tag:"Маркетинг · ATTRACT", title:"ИИ для маркетинга, уровень ATTRACT", desc:"Промптинг, AI-контент и основы SEO — если вы делаете первые шаги в AI-маркетинге."},
        "marketing-intermediate":{tag:"Маркетинг · CONVERT", title:"ИИ для маркетинга, уровень CONVERT", desc:"Техническое SEO, email-кампании и AI-агенты — для тех, кто уже строит маркетинг-процессы."},
        "marketing-advanced":{tag:"Маркетинг · GROW", title:"ИИ для маркетинга, уровень GROW", desc:"Омниканальные системы, MCP для martech и управление рисками по NIST AI RMF — для опытных маркетологов."}
      }
    },
    formats: {
      ...
      f2h:"Небольшие группы", f2p:"17–18 человек в группе — у преподавателя есть время разобрать вопрос каждого.",
      f3h:"12 занятий по 1,5 часа", f3p:"Уровень — это 12 занятий, между ними практика, а в конце капстоун-проект.",
    ...
    prog: {
      ...
      a1Who:"12 занятий по 1,5 часа · от 15 лет · без опыта",
      ...
      a2Who:"12 занятий по 1,5 часа · после CODE",
      ...
      a3Who:"12 занятий по 1,5 часа · после BUILD",
      ...
      m1Who:"12 занятий по 1,5 часа · от 15 лет · без опыта",
      ...
      m2Who:"12 занятий по 1,5 часа · после ATTRACT",
      ...
      m3Who:"12 занятий по 1,5 часа · после CONVERT",
      ...
      n1Who:"12 занятий по 1,5 часа · от 15 лет · без опыта",
      n2Who:"12 занятий по 1,5 часа · после CONNECT",
      n3Who:"12 занятий по 1,5 часа · после AUTOMATE",
    ...
    price: {
      ...
      formats:"Кроме группы есть другие форматы: мини-группа на 8±2 человека, группа из трёх человек и индивидуальные занятия — тоже 12 занятий в месяц. Стоимость этих форматов считаем на консультации.",
      note:"Цены указаны за месяц обучения. Уровень — это 12 занятий по 1,5 часа; итоговую сумму и график оплаты считаем на бесплатной консультации, под ваш уровень и направление. Первое занятие на стартовом уровне — бесплатное.",
      currency:"сум / месяц",
      a1_1:"12 занятий по 1,5 часа", a1_2:"Группы 17–18 человек", a1_3:"Капстоун-проект + тест",
      a2_1:"12 занятий по 1,5 часа", a2_2:"Личная проверка работ", a2_3:"Full-stack продукт с оплатой",
      a3_1:"12 занятий по 1,5 часа", a3_2:"Разбор production-кейсов", a3_3:"Запуск SaaS-продукта",
      m1_1:"12 занятий по 1,5 часа", m1_2:"Группы 17–18 человек", m1_3:"Маркетинг-план + защита",
      m2_1:"12 занятий по 1,5 часа", m2_2:"Личная проверка работ", m2_3:"Обновлённый маркетинг-план",
      m3_1:"12 занятий по 1,5 часа", m3_2:"Разбор enterprise-кейсов", m3_3:"Омниканальная система",
      n1_1:"12 занятий по 1,5 часа", n1_2:"Группы 17–18 человек", n1_3:"Рабочая автоматизация + тест",
      n2_1:"12 занятий по 1,5 часа", n2_2:"Личная проверка работ", n2_3:"AI-агент с оплатой",
      n3_1:"12 занятий по 1,5 часа", n3_2:"Разбор реальных систем", n3_3:"Омниканальная система",
    ...
    outcome: {
      h3:"Что остаётся у вас после уровня",
      lead:"Не отметка о посещаемости, а три вещи, которые можно показать работодателю или заказчику.",
      c1h:"Проекты в портфолио",
      c1p:"Не один проект, а несколько: работы с занятий и капстоун уровня. Всё опубликовано и открывается по ссылке — можно показать, а не рассказать.",
      c2h:"Резюме (CV)",
      c2p:"На последних занятиях собираем резюме на русском и английском: проекты, инструменты, ваша роль в каждой работе. Разбираем, как отвечать на вопросы по нему.",
      c3h:"Сертификат ThinkLike AI",
      c3p:"Выдаётся после защиты капстоуна и сертификационного теста — за результат, а не за посещаемость."
    },
    faq: {
      h2:"Частые вопросы", num:"Коротко о главном",
      q1:"Мне нужен опыт, чтобы начать?",
      a1:"Нет. Стартовый уровень каждого направления рассчитан на полных новичков — от 15 лет, без опыта. Если не уверены, какое направление и уровень подойдут, пройдите короткий AI-тест в начале страницы.",
      q2:"Можно сразу пойти на второй или третий уровень?",
      a2:"Уровни идут подряд, потому что на втором уровне мы с первого занятия работаем на том, что собрано на первом. Если у вас уже есть опыт — скажите на консультации, посмотрим ваши работы и решим, с чего начать.",
      ...
      a4:"Уровень — это 12 занятий по 1,5 часа, в группах 17–18 человек, с практикой между занятиями и капстоун-проектом в конце. Обычно 2–3 занятия в неделю; точный график зависит от набора.",
      q5:"Что я получаю по итогам уровня?",
      a5:"Три вещи: проекты в портфолио — не один, а несколько, все опубликованы и открываются по ссылке; резюме (CV) на русском и английском, собранное на последних занятиях; и сертификат ThinkLike AI после защиты капстоуна и сертификационного теста. Отметки о посещаемости мы не выдаём.",
      q6:"Сколько стоит обучение и есть ли рассрочка?",
      a6:"В разделе «Цены» указана стоимость месяца обучения. Уровень — это 12 занятий по 1,5 часа, поэтому итоговую сумму считаем вместе на бесплатной консультации — там же обсуждаем рассрочку. Первое занятие на стартовом уровне бесплатное: можно прийти и посмотреть до всякой оплаты.",
    ...
    cons: {
      crumb:"Внедрение ИИ в бизнес",
      title:"Внедрение ИИ в бизнес",
      lead:"Это не курс. Мы разбираем ваши процессы, показываем, где ИИ действительно экономит время и деньги, и внедряем сами — с обучением вашей команды и поддержкой после запуска.",
      ctaShort:"Запросить диагностику",
      f1:"диагностика бесплатно", f2:"офлайн в Ташкенте", f3:"оплата по этапам", f4:"сопровождение после запуска",
      whoTitle:"Кому это подходит", whoNum:"Три ситуации, с которыми приходят чаще всего",
      w1h:"Малый и средний бизнес",
      w1p:"Заявки теряются в переписке, заказы переписываются в тетрадь, отчёт собирается вручную по вечерам. Здесь автоматизация окупается быстрее всего.",
      w2h:"Отделы продаж и поддержки",
      w2p:"Одни и те же вопросы клиентов по кругу, ручная сортировка заявок, сводка по понедельникам, которую кто-то собирает полдня.",
      w3h:"Те, кто уже пробовал",
      w3p:"Бот или пара сценариев есть, но они периодически ломаются и никто не знает почему. Приводим в рабочее состояние и оставляем документацию.",
      howTitle:"Как мы работаем", howNum:"От диагностики до сопровождения",
      s1h:"Бесплатная диагностика",
      s1p:"Час разговора: разбираем процессы и считаем, сколько времени уходит на повторяющуюся работу. По итогам честно говорим, есть ли здесь место для ИИ — и если нет, так и скажем.",
      s2h:"Карта автоматизации и смета",
      s2p:"Письменный документ: что автоматизируем и в каком порядке, что это даёт в часах и суммах, сколько стоит и сколько занимает по времени.",
      s3h:"Внедрение",
      s3p:"Собираем и запускаем на ваших данных и ваших аккаунтах. Ничего не остаётся «у подрядчика»: доступы ваши, всё работает без нас.",
      s4h:"Обучение вашей команды",
      s4p:"Показываем, как это работает и что делать, если сломается. Оставляем инструкцию на русском или узбекском, написанную для не-технаря.",
      s5h:"Сопровождение",
      s5p:"Следим за ошибками, чиним сбои и дорабатываем по мере роста. Объём и срок — по договорённости, отдельно от внедрения.",
      whatTitle:"Что именно внедряем", whatNum:"Всё на бесплатных или недорогих тарифах",
      whatLead:"Берём не «ИИ ради ИИ», а те задачи, где видно результат в часах и деньгах. Обычно это одно-два направления на старте, а не всё сразу.",
      i1l:"Telegram-бот для клиентов",
      i1r:"Отвечает на вопросы о цене, доставке, адресе и статусе заказа — и передаёт человеку, когда не знает",
      i2l:"Заявки в одном месте",
      i2r:"Форма на сайте, Instagram и Telegram сводятся в одну таблицу или базу, с уведомлением за секунды",
      i3l:"Приём оплат",
      i3r:"Click.uz и Payme с проверкой платежа на сервере, автоматическим чеком и записью в базу",
      i4l:"Квалификация заявок",
      i4r:"ИИ задаёт три вопроса и передаёт менеджеру только тех, кто готов покупать",
      i5l:"Отчёты без таблиц",
      i5r:"Сводка за неделю приходит в Telegram сама — в понедельник утром, без чьего-либо участия",
      i6l:"ИИ поверх ваших данных",
      i6r:"Ответы на вопросы по вашим же таблицам и документам, на русском и узбекском",
      vsTitle:"Чем это отличается от курса автоматизации",
      vsText:"На курсе вы учитесь строить такие системы сами: дешевле, дольше, но навык остаётся с вами навсегда. Здесь мы строим их за вас: быстрее, но платите за результат. Часто берут и то и другое — внедрение сейчас, обучение сотрудника параллельно.",
      vsLink:"Курс «ИИ для автоматизации» →",
      priceNote:"Стоимость называем после бесплатной диагностики — она зависит от числа процессов и интеграций. Назвать честную цифру, не посмотрев на ваши процессы, невозможно, поэтому прайса на этой странице нет.",
      applyTitle:"Запросить диагностику",
      company:"Компания и сфера",
      task:"Какую задачу хотите закрыть",
      submit:"Отправить запрос",
      sideLead:"Опишите задачу в двух словах — на диагностике разберём подробно. Она ни к чему не обязывает.",
      homeTitle:"Нужно внедрить ИИ, а не учиться?",
      homeText:"Разбираем процессы вашей компании, показываем, где ИИ экономит время и деньги, и внедряем сами — с обучением команды и поддержкой после запуска. Диагностика бесплатная.",
      homeLink:"Подробнее о внедрении →"
    },
    // названия уровней у каждого направления свои — a: вайб-кодинг, n: автоматизация, m: маркетинг
    lvl: {
      a1:"CODE", a2:"BUILD", a3:"LAUNCH",
      n1:"CONNECT", n2:"AUTOMATE", n3:"SCALE",
      m1:"ATTRACT", m2:"CONVERT", m3:"GROW"
    },
    ...
    au: {
      ...
      f1:"3 уровня · 36 занятий", f2:"12 занятий по 1,5 часа", f3:"группы 17–18 человек", f4:"без кода, с нуля",
    ...
    vc: {
      ...
      f1:"3 уровня · 36 занятий", f2:"2–3 занятия в неделю", f3:"группы 17–18 человек", f4:"первое занятие бесплатно",
      ...
      secL1:"CODE 8 · Секреты и ключи", secR1:"Ничто, что вас опознаёт, не лежит в коде",
      secL2:"CODE 10 · Правила доступа", secR2:"Экран входа — это ещё не защита",
      secL3:"BUILD 8 · Безопасность денег", secR3:"Проверь каждый платёжный колбэк, прежде чем ему верить",
      secL4:"LAUNCH 5 · Мыслить как атакующий", secR4:"Проверь свой продукт по чек-листу атакующего",
      secL5:"LAUNCH 6 · Починить, укрепить, доказать", secR5:"Состязательное тестирование и письменный отчёт",
    ...
    mk: {
      ...
      f1:"3 уровня · 36 занятий", f2:"12 занятий по 1,5 часа", f3:"группы 17–18 человек", f4:"от 15 лет, без опыта",
  ...
  uz: {
    nav: { test:"AI-test", philosophy:"Falsafa", programs:"Kurslar", pricing:"Narxlar", process:"Jarayon", faq:"Savollar", contact:"Aloqa", contactBtn:"Aloqa", cta:"Ro‘yxatdan o‘tish", themeToDark:"Tungi rejimni yoqish", themeToLight:"Kunduzgi rejimni yoqish" , consulting:"Biznes uchun"},
    hero: {
    ...
    quiz: {
      ...
      results:{
        "vibecoding-beginner":{tag:"Vibe Coding · CODE", title:"Vibe Coding, CODE darajasi", desc:"Replit, Lovable va bitta ham kod yozmasdan birinchi ilova — hammasi brauzerda, hech narsa o‘rnatish kerak emas. Birinchi dars bepul: kelib tekshirish mumkin."},
        "vibecoding-intermediate":{tag:"Vibe Coding · BUILD", title:"Vibe Coding, BUILD darajasi", desc:"Kompyuteringizdagi Cursor va Claude Code, bog‘langan jadvalli baza, serverda tekshiriladigan Click va Payme to‘lovi — birinchi prototipi tayyor bo‘lganlar uchun."},
        "vibecoding-advanced":{tag:"Vibe Coding · LAUNCH", title:"Vibe Coding, LAUNCH darajasi", desc:"CI/CD, o‘z mahsulotini hujumchi ko‘zi bilan audit qilish va SaaS ishga tushirish — mahsulotni haqiqiy foydalanuvchilarga yetkazib, himoya qilishga tayyor bo‘lganlar uchun."},
        "automation-beginner":{tag:"Avtomatlashtirish · CONNECT", title:"Avtomatlashtirish uchun AI, CONNECT darajasi", desc:"Make.com va mijozlarga o‘zi javob beradigan Telegram-bot. Kodsiz — jadvallardan foydalana olsangiz, uddalaysiz."},
        "automation-intermediate":{tag:"Avtomatlashtirish · AUTOMATE", title:"Avtomatlashtirish uchun AI, AUTOMATE darajasi", desc:"Vebhuklar, AI-agentlar va Click yoki Payme orqali to‘lov — birinchi ssenariylari allaqachon ishlayotganlar uchun."},
        "automation-advanced":{tag:"Avtomatlashtirish · SCALE", title:"Avtomatlashtirish uchun AI, SCALE darajasi", desc:"Flowise, n8n va avtohisobotli ko‘p kanalli tizim — agentliksiz agentlik darajasidagi tizim kerak bo‘lganlar uchun."},
        "marketing-beginner":{tag:"Marketing · ATTRACT", title:"Marketing uchun AI, ATTRACT darajasi", desc:"Prompting, AI-kontent va SEO asoslari — AI-marketingda birinchi qadamlarni qo‘yayotganlar uchun."},
        "marketing-intermediate":{tag:"Marketing · CONVERT", title:"Marketing uchun AI, CONVERT darajasi", desc:"Texnik SEO, email-kampaniyalar va AI-agentlar — marketing jarayonlarini allaqachon quryotganlar uchun."},
        "marketing-advanced":{tag:"Marketing · GROW", title:"Marketing uchun AI, GROW darajasi", desc:"Ko‘p kanalli tizimlar, martech uchun MCP va NIST AI RMF bo‘yicha xatarlarni boshqarish — tajribali marketologlar uchun."}
      }
    },
    formats: {
      ...
      f2h:"Kichik guruhlar", f2p:"Guruhda 17–18 kishi — o\u2018qituvchida har birining savolini ko\u2018rib chiqishga vaqt bor.",
      f3h:"1,5 soatdan 12 ta dars", f3p:"Daraja — 12 ta dars, ular orasida amaliyot, oxirida esa capstone-loyiha.",
    ...
    prog: {
      ...
      a1Who:"1,5 soatdan 12 ta dars · 15 yoshdan · tajribasiz",
      ...
      a2Who:"1,5 soatdan 12 ta dars · CODE'dan keyin",
      ...
      a3Who:"1,5 soatdan 12 ta dars · BUILD'dan keyin",
      ...
      m1Who:"1,5 soatdan 12 ta dars · 15 yoshdan · tajribasiz",
      ...
      m2Who:"1,5 soatdan 12 ta dars · ATTRACT'dan keyin",
      ...
      m3Who:"1,5 soatdan 12 ta dars · CONVERT'dan keyin",
      ...
      n3Tools:"Flowise · n8n · Airtable · Glide",
      n1Who:"1,5 soatdan 12 ta dars · 15 yoshdan · tajribasiz",
      n2Who:"1,5 soatdan 12 ta dars · CONNECT'dan keyin",
      n3Who:"1,5 soatdan 12 ta dars · AUTOMATE'dan keyin",
    ...
    price: {
      ...
      formats:"Guruhdan tashqari boshqa formatlar ham bor: 8±2 kishilik mini-guruh, uch kishilik guruh va yakka tartibdagi darslar — ularda ham oyiga 12 ta dars. Bu formatlar narxini konsultatsiyada hisoblaymiz.",
      note:"Narxlar bir oylik o\u2018qish uchun ko\u2018rsatilgan. Daraja — 1,5 soatdan 12 ta dars; yakuniy summa va to\u2018lov grafigini yo\u2018nalish va darajangizga qarab bepul konsultatsiyada hisoblaymiz. Boshlang\u2018ich darajaning birinchi darsi — bepul.",
      currency:"so\u2018m / oy",
      a1_1:"12 ta 1,5 soatlik dars", a1_2:"17–18 kishilik guruh", a1_3:"Capstone-loyiha + test",
      a2_1:"12 ta 1,5 soatlik dars", a2_2:"Ishlarni shaxsiy tekshirish", a2_3:"To\u2018lovli full-stack mahsulot",
      a3_1:"12 ta 1,5 soatlik dars", a3_2:"Production-keyslarni tahlil qilish", a3_3:"SaaS-mahsulotni ishga tushirish",
      m1_1:"12 ta 1,5 soatlik dars", m1_2:"17–18 kishilik guruh", m1_3:"Marketing-reja + himoya",
      m2_1:"12 ta 1,5 soatlik dars", m2_2:"Ishlarni shaxsiy tekshirish", m2_3:"Yangilangan marketing-reja",
      m3_1:"12 ta 1,5 soatlik dars", m3_2:"Enterprise-keyslarni tahlil qilish", m3_3:"Ko\u2018p kanalli tizim",
      n1_1:"12 ta 1,5 soatlik dars", n1_2:"17–18 kishilik guruh", n1_3:"Ishlaydigan avtomatlashtirish + test",
      n2_1:"12 ta 1,5 soatlik dars", n2_2:"Ishlarni shaxsiy tekshirish", n2_3:"To‘lovli AI-agent",
      n3_1:"12 ta 1,5 soatlik dars", n3_2:"Haqiqiy tizimlar tahlili", n3_3:"Ko‘p kanalli tizim",
    ...
    outcome: {
      h3:"Daraja tugagach sizda nima qoladi",
      lead:"Davomat belgisi emas, balki ish beruvchiga yoki buyurtmachiga ko\u2018rsatsa bo\u2018ladigan uchta narsa.",
      c1h:"Portfeldagi loyihalar",
      c1p:"Bitta emas, bir nechta loyiha: darsdagi ishlar va daraja capstone\u2018i. Hammasi nashr etilgan va havola orqali ochiladi — aytib berish emas, ko\u2018rsatish mumkin.",
      c2h:"Rezyume (CV)",
      c2p:"Oxirgi darslarda rus va ingliz tillarida rezyume tuzamiz: loyihalar, vositalar, har bir ishdagi rolingiz. Undagi savollarga qanday javob berishni ham ko\u2018rib chiqamiz.",
      c3h:"ThinkLike AI sertifikati",
      c3p:"Capstone himoyasi va sertifikatlash testidan keyin beriladi — davomat uchun emas, natija uchun."
    },
    faq: {
      h2:"Ko‘p beriladigan savollar", num:"Qisqacha asosiy narsalar",
      q1:"Boshlash uchun tajriba kerakmi?",
      a1:"Yo\u2018q. Har bir yo\u2018nalishning boshlang\u2018ich darajasi butunlay yangi boshlovchilar uchun — 15 yoshdan, tajribasiz. Qaysi yo\u2018nalish va daraja sizga mosligiga ishonchingiz komil bo\u2018lmasa, sahifa boshidagi qisqa AI-testdan o\u2018ting.",
      q2:"Darhol ikkinchi yoki uchinchi darajadan boshlasa bo\u2018ladimi?",
      a2:"Darajalar ketma-ket boradi, chunki ikkinchi darajada birinchi darsdanoq birinchi darajada yig\u2018ilgan narsa ustida ishlaymiz. Tajribangiz bo\u2018lsa — konsultatsiyada ayting, ishingizni ko\u2018rib, qayerdan boshlashni hal qilamiz.",
      ...
      a4:"Daraja — 17–18 kishilik guruhlarda 1,5 soatdan 12 ta dars, darslar orasida amaliyot va oxirida capstone-loyiha bilan. Odatda haftasiga 2–3 dars; aniq grafik guruhga bog‘liq.",
      q5:"Daraja oxirida nima olaman?",
      a5:"Uchta narsa: portfeldagi loyihalar — bitta emas, bir nechta, barchasi nashr etilgan va havola orqali ochiladi; oxirgi darslarda tuzilgan rus va ingliz tilidagi rezyume (CV); va capstone himoyasi hamda sertifikatlash testidan keyin ThinkLike AI sertifikati. Davomat belgisini bermaymiz.",
      q6:"O‘qish qancha turadi va muddatli to‘lov bormi?",
      a6:"«Narxlar» bo\u2018limida bir oylik o\u2018qish narxi ko\u2018rsatilgan. Daraja — 1,5 soatdan 12 ta dars, shuning uchun yakuniy summani bepul konsultatsiyada birga hisoblaymiz — muddatli to\u2018lovni ham o\u2018sha yerda kelishamiz. Boshlang\u2018ich darajaning birinchi darsi bepul: to\u2018lovdan oldin kelib ko\u2018rish mumkin.",
    ...
    cons: {
      crumb:"Biznesga AI joriy etish",
      title:"Biznesga AI joriy etish",
      lead:"Bu kurs emas. Biz jarayonlaringizni ko‘rib chiqamiz, AI qayerda haqiqatan ham vaqt va pul tejashini ko‘rsatamiz va o‘zimiz joriy qilamiz — jamoangizni o‘qitib va ishga tushgandan keyin ham qo‘llab-quvvatlab.",
      ctaShort:"Diagnostika so‘rash",
      f1:"diagnostika bepul", f2:"Toshkentda oflayn", f3:"to‘lov bosqichma-bosqich", f4:"ishga tushgandan keyin qo‘llab-quvvatlash",
      whoTitle:"Bu kimga mos", whoNum:"Eng ko‘p uchraydigan uchta holat",
      w1h:"Kichik va o‘rta biznes",
      w1p:"Arizalar yozishmalarda yo‘qoladi, buyurtmalar daftarga ko‘chiriladi, hisobot kechqurun qo‘lda yig‘iladi. Avtomatlashtirish aynan shu yerda eng tez qoplanadi.",
      w2h:"Sotuv va qo‘llab-quvvatlash bo‘limlari",
      w2p:"Mijozlarning bir xil savollari aylanib yuradi, arizalar qo‘lda saralanadi, dushanba sarhisobini kimdir yarim kun yig‘adi.",
      w3h:"Allaqachon urinib ko‘rganlar",
      w3p:"Bot yoki bir nechta stsenariy bor, lekin vaqti-vaqti bilan buziladi va nega buzilganini hech kim bilmaydi. Ishlaydigan holatga keltiramiz va hujjat qoldiramiz.",
      howTitle:"Qanday ishlaymiz", howNum:"Diagnostikadan qo‘llab-quvvatlashgacha",
      s1h:"Bepul diagnostika",
      s1p:"Bir soatlik suhbat: jarayonlarni ko‘rib chiqamiz va takrorlanadigan ishga qancha vaqt ketayotganini hisoblaymiz. Natijada bu yerda AI uchun o‘rin bor-yo‘qligini ochiq aytamiz — bo‘lmasa, shundoq deymiz.",
      s2h:"Avtomatlashtirish xaritasi va smeta",
      s2p:"Yozma hujjat: nimani va qanday tartibda avtomatlashtiramiz, bu soat va summada nima beradi, qancha turadi va qancha vaqt oladi.",
      s3h:"Joriy etish",
      s3p:"Sizning ma’lumotlaringiz va akkauntlaringizda yig‘amiz va ishga tushiramiz. Hech narsa «pudratchida» qolmaydi: kirish huquqlari sizniki, hammasi bizsiz ham ishlaydi.",
      s4h:"Jamoangizni o‘qitish",
      s4p:"Bu qanday ishlashini va buzilsa nima qilish kerakligini ko‘rsatamiz. Rus yoki o‘zbek tilida, texnik bo‘lmagan odam uchun yozilgan yo‘riqnoma qoldiramiz.",
      s5h:"Qo‘llab-quvvatlash",
      s5p:"Xatolarni kuzatamiz, uzilishlarni tuzatamiz va o‘sish bilan birga takomillashtiramiz. Hajm va muddat — kelishuv bo‘yicha, joriy etishdan alohida.",
      whatTitle:"Aynan nimani joriy qilamiz", whatNum:"Hammasi bepul yoki arzon tariflarda",
      whatLead:"«AI uchun AI» emas, natijasi soat va pulda ko‘rinadigan vazifalarni olamiz. Odatda boshida bir-ikki yo‘nalish, hammasi birdan emas.",
      i1l:"Mijozlar uchun Telegram-bot",
      i1r:"Narx, yetkazib berish, manzil va buyurtma holati haqidagi savollarga javob beradi — bilmaganda odamga uzatadi",
      i2l:"Arizalar bir joyda",
      i2r:"Saytdagi forma, Instagram va Telegram bitta jadval yoki bazaga yig‘iladi, bildirishnoma soniyalarda keladi",
      i3l:"To‘lovlarni qabul qilish",
      i3r:"Click.uz va Payme — to‘lovni serverda tekshirish, avtomatik chek va bazaga yozuv bilan",
      i4l:"Arizalarni saralash",
      i4r:"AI uchta savol beradi va menejerga faqat sotib olishga tayyorlarini uzatadi",
      i5l:"Jadvalsiz hisobotlar",
      i5r:"Haftalik sarhisob Telegramga o‘zi keladi — dushanba ertalab, hech kimning ishtirokisiz",
      i6l:"Sizning ma’lumotlaringiz ustida AI",
      i6r:"O‘z jadval va hujjatlaringiz bo‘yicha savollarga javob, rus va o‘zbek tilida",
      vsTitle:"Avtomatlashtirish kursidan farqi nimada",
      vsText:"Kursda siz bunday tizimlarni o‘zingiz qurishni o‘rganasiz: arzonroq, uzoqroq, lekin ko‘nikma siz bilan abadiy qoladi. Bu yerda esa biz ularni siz uchun quramiz: tezroq, lekin natija uchun to‘laysiz. Ko‘pincha ikkalasini ham oladi — hozir joriy etish, parallel ravishda xodimni o‘qitish.",
      vsLink:"«Avtomatlashtirish uchun AI» kursi →",
      priceNote:"Narxni bepul diagnostikadan keyin aytamiz — u jarayonlar va integratsiyalar soniga bog‘liq. Jarayonlaringizni ko‘rmasdan halol raqam aytib bo‘lmaydi, shuning uchun bu sahifada prays yo‘q.",
      applyTitle:"Diagnostika so‘rash",
      company:"Kompaniya va soha",
      task:"Qaysi vazifani yopmoqchisiz",
      submit:"So‘rov yuborish",
      sideLead:"Vazifani ikki og‘iz so‘zda yozing — diagnostikada batafsil ko‘rib chiqamiz. U hech narsaga majbur qilmaydi.",
      homeTitle:"O‘qish emas, AI joriy etish kerakmi?",
      homeText:"Kompaniyangiz jarayonlarini ko‘rib chiqamiz, AI qayerda vaqt va pul tejashini ko‘rsatamiz va o‘zimiz joriy qilamiz — jamoani o‘qitib va ishga tushgandan keyin qo‘llab-quvvatlab. Diagnostika bepul.",
      homeLink:"Joriy etish haqida batafsil →"
    },
    lvl: {
      a1:"CODE", a2:"BUILD", a3:"LAUNCH",
      n1:"CONNECT", n2:"AUTOMATE", n3:"SCALE",
    ...
    au: {
      ...
      f1:"3 daraja · 36 dars", f2:"1,5 soatdan 12 ta dars", f3:"17–18 kishilik guruh", f4:"kodsiz, noldan",
    ...
    vc: {
      ...
      f1:"3 daraja · 36 dars", f2:"haftasiga 2–3 dars", f3:"17–18 kishilik guruh", f4:"birinchi dars bepul",
      ...
      secL1:"CODE 8 · Sirlar va kalitlar", secR1:"Sizni tanitadigan hech narsa kodda yotmaydi",
      secL2:"CODE 10 · Kirish qoidalari", secR2:"Kirish ekrani — bu hali himoya emas",
      secL3:"BUILD 8 · Pul xavfsizligi", secR3:"Har bir to‘lov chaqiruvini ishonishdan oldin tekshir",
      secL4:"LAUNCH 5 · Hujumchi kabi fikrlash", secR4:"O‘z mahsulotingizni hujumchi ro‘yxati bo‘yicha tekshir",
      secL5:"LAUNCH 6 · Tuzatish, mustahkamlash, isbotlash", secR5:"Raqobatli sinov va yozma hisobot",
    ...
    mk: {
      ...
      f1:"3 daraja · 36 dars", f2:"1,5 soatdan 12 ta dars", f3:"17–18 kishilik guruh", f4:"15 yoshdan, tajribasiz",
...
/* какой тариф нажал человек перед тем, как прокрутиться к форме —
   раньше эта информация никуда не уходила, и менеджер не знал, о каком курсе речь */
let selectedProgram = '';
document.querySelectorAll('[data-program]').forEach(el => {
  el.addEventListener('click', () => { selectedProgram = el.getAttribute('data-program') || ''; });
});
...
if (applyForm) {
  ...
  applyForm.addEventListener('submit', async (e) => {
    ...
    // страница внедрения ИИ помечает форму data-kind="consulting" —
    // чтобы в Telegram было сразу видно, что это не заявка на обучение
    const isConsulting = applyForm.dataset.kind === 'consulting';

    const lines = [
      isConsulting ? '🏢 Заявка на внедрение ИИ — ThinkLike AI' : '📩 Новая заявка — ThinkLike AI',
      `Имя: ${name}`,
      company ? `Компания: ${company}` : null,
      `Телефон: ${phone}`,
      telegram ? `Telegram: ${telegram}` : null,
      (!isConsulting && selectedProgram) ? `Программа: ${selectedProgram}` : null,
      message ? `${isConsulting ? 'Задача' : 'Комментарий'}: ${message}` : null
    ].filter(Boolean);
